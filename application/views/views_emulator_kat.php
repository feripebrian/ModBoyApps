			...
			<div class="col-xs-12 col-md-8">
				<div class="col-xs-12 col-md-12" style="border: 0px solid #999;border-radius: 10px;box-shadow: 2px 2px 5px #888888;margin-bottom: 10px;">
					<div class="features-sec">
						<?php foreach ($emulator_kat as $g) { ?>
							<div class="col-md-4 col-sm-6 col-xs-12 wow fadeInUp" style="height: 90px;">
								<div class="media service-box">
									<div class="pull-left">
										<img style="height: 64px;width: 64px;" src="<?php echo $g['gambar'] ?>" class="img-circle img-responsive" alt="<?php echo $g['kategori'] ?>">
									</div>
									<div class="media-body">
										<?php echo anchor('emulator/' . $g['id_kategori'], '<h4>' . $g['kategori'] . '</h4>', '') ?>
									</div>
								</div>
							</div>
						<?php } ?>
