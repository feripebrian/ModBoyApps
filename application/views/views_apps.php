				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li><a class="scroll" href="#blog">Game</a></li>
							<li><a class="scroll" href="#features">Apps</a></li>
				...
				<div class="col-md-6 ">
					<div class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active feat-sec">
							<div class="col-md-4 tab-img"><img src="<?php echo base_url() ?>assets/main_page/images/Features/01.jpg" class="img-responsive" alt=""></div>
					...
					<div class="col-md-3 col-sm-6 col-xs-6 wow fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms">
						<div class="media service-box">
							...
							<div class="media-body">
								...
								<a href="">
									<h5 class="media-heading" style="line-height: 64px;">Action</h5>
								</a>
							</div>
						</div>
					</div>
