...
<div class="content-wrapper">
	<div class="card card-info">
		...
		<div class="card-header">
			<h3 class="card-title">Edit Apps</h3>
		</div>
		<!-- /.card-header -->
		<!-- form start -->
		<?php foreach ($app_edit as $row) { ?>
			<?php echo form_open('dashboard/app/editapps/app_update/' . $row['id_post'], 'class="form-horizontal"') ?>
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_textarea('deskripsi_singkat', $row['deskripsi_singkat'], 'class="form-control" onkeyup="count_up(this);" id="inputdescription" placeholder="Description Singkat Max 160 Karakter" maxlength="160"') ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_input('judul', $row['judul'], 'class="form-control" id="inputjudul" class="form-control" placeholder="Judul"') ?>
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_input('uri', $row['uri'], 'class="form-control" id="inputurl" placeholder="URL"') ?>
					</div>
				</div>
				<div class="form-group row">
