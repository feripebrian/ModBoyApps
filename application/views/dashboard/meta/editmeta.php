				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-xlicon_32">
								Choose file
							</button>
						</div>
						<div class="modal fade" id="modal-xlicon_32">
							<div class="modal-dialog modal-xlicon_32">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-xlicon_128">
								Choose file
							</button>
						</div>
						<div class="modal fade" id="modal-xlicon_128">
							<div class="modal-dialog modal-xlicon_128">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="modal-title">File Manager</h4>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-xlicon_192">
								Choose file
							</button>
						</div>
						<div class="modal fade" id="modal-xlicon_192">
							<div class="modal-dialog modal-xlicon_192">
								<div class="modal-content">
									<div class="modal-header">
										<h4 class="modal-title">File Manager</h4>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
