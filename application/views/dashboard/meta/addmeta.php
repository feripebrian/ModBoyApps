		...
		<form>
			<div class="card-body">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_textarea('description', '', 'class="form-control" placeholder="Description"') ?>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputlogo" class="col-sm-2 col-form-label">Logo 96x39</label>
					<div class="col-sm-10">
						<?php echo form_input('logo', '', 'class="form-control" id="logo" placeholder="Logo 96x39"') ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_input('icon_32', '', 'class="form-control" id="icon_32" placeholder="Icon 32X32"') ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_input('icon_128', '', 'class="form-control" id="icon_128" placeholder="Icon 128X128"') ?>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						<?php echo form_input('icon_192', '', 'class="form-control" id="icon_192" placeholder="Icon 192X129"') ?>
