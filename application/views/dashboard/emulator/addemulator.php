...
<div class="content-wrapper">
	<div class="card card-info">
		...
		<div class="card-header">
			<h3 class="card-title">Add Emulator</h3>
		</div>
		<!-- /.card-header -->
		<!-- form start -->
		<?php echo form_open('dashboard/emulator/addemulator/emulator_add/', 'class="form-horizontal"') ?>
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<div class="form-group">
						<?php
						foreach ($kategori_emulator as $row) {
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<?php echo form_input('judul', '', 'class="form-control" id="inputjudul" class="form-control" placeholder="Judul Emulator"') ?>
				</div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<?php echo form_input('link', '', 'class="form-control" id="inputlink" placeholder="Link Download"') ?>
				</div>
			</div>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					echo form_dropdown('bintang', $options, '', 'class="custom-select"');
					?>
				</div>
			</div>
			<div class="form-group row">
		...
		<div class="card-footer">
			...
			<?php echo anchor('dashboard/emulator/listemulator', 'Cancel', 'class="btn btn-default float-right"') ?>
		</div>
		<!-- /.card-footer -->
		<?php echo form_close() ?>
	</div>
