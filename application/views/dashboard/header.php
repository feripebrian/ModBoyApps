			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						...
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<?php echo anchor('dashboard/emulator_kategori/listemulatorkategori', '<ion-icon name="list-circle"></ion-icon><p>List Emulator Kategori</p>', 'class="nav-link"') ?>
								</li>
								<li class="nav-item">
									<?php echo anchor('dashboard/emulator_kategori/addemulatorkategori', '<ion-icon name="add-circle"></ion-icon><p>Add Emulator Kategori</p>', 'class="nav-link"') ?>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<?php echo anchor('dashboard/emulator/listemulator', '<ion-icon name="list-circle"></ion-icon><p>List Emulator </p>', 'class="nav-link"') ?>
								</li>
								<li class="nav-item">
									<?php echo anchor('dashboard/emulator/addemulator', '<ion-icon name="add-circle"></ion-icon><p>Add Emulator </p>', 'class="nav-link"') ?>
								</li>
							</ul>
						</li>
						<li class="nav-item">
							...
							<ul class="nav nav-treeview">
								<li class="nav-item">
									<?php echo anchor('dashboard/rom/listrom', '<ion-icon name="list-circle"></ion-icon><p>List Rom </p>', 'class="nav-link"') ?>
								</li>
								<li class="nav-item">
									<?php echo anchor('dashboard/rom/addrom', '<ion-icon name="add-circle"></ion-icon><p>Add Rom </p>', 'class="nav-link"') ?>
								</li>
							</ul>
						</li>
						...
						<li class="nav-item">
							<?php echo anchor('dashboard/sitemap/sitemap', '<i class="nav-icon far fa-circle text-info"></i><p>SITEMAP</p>', ' class="nav-link"') ?>
						</li>
						<li class="nav-item">
							<?php echo anchor('dashboard/setting/setting', '<i class="nav-icon far fa-circle text-info"></i><p>SETTING</p>', ' class="nav-link"') ?>
						</li>
						<li class="nav-item">
							<a href="#" class="nav-link">
