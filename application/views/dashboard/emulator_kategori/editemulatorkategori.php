...
<div class="content-wrapper">
	<div class="card card-info">
		...
		<div class="card-header">
			<h3 class="card-title">Edit Emulator Kategori</h3>
		</div>
		<!-- /.card-header -->
		<!-- form start -->
		<?php foreach ($emulator_kategori_edit as $row) { ?>
			<?php echo form_open('dashboard/emulator_kategori/editemulatorkategori/emulator_kategori_update/' . $row['id_kategori'], 'class="form-horizontal"') ?>
			<div class="card-body">
			...
			<div class="card-footer">
				...
				<?php echo anchor('dashboard/emulator_kategori/listemulatorkategori', 'Cancel', 'class="btn btn-default float-right"') ?>
			</div>
			<!-- /.card-footer -->
			<?php echo form_close() ?>
		<?php } ?>
