...
<div class="content-wrapper">
	<div class="card card-info">
		...
		<div class="card-header">
			<h3 class="card-title">Add Emulator Kategori</h3>
		</div>
		<!-- /.card-header -->
		<!-- form start -->
		<?php echo form_open('dashboard/emulator_kategori/addemulatorkategori/emulator_kategori_add/', 'class="form-horizontal"') ?>
		<form>
			<div class="card-body">
