...
<div class="content-wrapper">
	<div class="card card-info">
		...
		<!-- /.card-header -->
		<!-- form start -->
		<?php echo form_open('dashboard/socialmedia/addmedia/media_add/', 'class="form-horizontal"') ?>
		<form>
			<div class="card-body">
				<div class="form-group row">
					<label for="inputNama" class="col-sm-2 col-form-label">Nama</label>
					<div class="col-sm-10">
						<?php echo form_input('nama', '', 'type="text" class="form-control" id="inputNama" placeholder="Nama" ') ?>
					</div>
				</div>
				<div class="form-group row">
					<label for="inputLink" class="col-sm-2 col-form-label">Link</label>
					<div class="col-sm-10">
						<?php echo form_input('link', '', 'type="text" class="form-control" id="inputLink" placeholder="Link" ') ?>
					</div>
				</div>
				<div class="form-group row">
