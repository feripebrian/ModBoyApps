				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li><?php echo anchor('game', 'Game') ?></li>
							<li><?php echo anchor('apk', 'Apps') ?></li>
							<li><?php echo anchor('tutorial', 'Tutorial') ?></li>
							<li><?php echo anchor('emulator', 'Emulator') ?></li>
							<li><?php echo anchor('rom', 'Rom') ?></li>
							<li>
								<?php echo form_open('search', '') ?>
								<div class="controls">
									<?php echo form_input('keyword', '', 'class="form-control input-sm" placeholder="Search"') ?>
								</div>
								<?php echo form_close() ?>
							</li>
						</ul>
